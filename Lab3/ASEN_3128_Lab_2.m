...
uncontrolled_3D = {'5^o roll','start of flight path','end of flight path',...
    '5^o pitch','start of flight path','end of flight path','5^o yaw',...
    'start of flight path','end of flight path','0.1 rad/s roll rate',...
    'start of flight path','end of flight path','0.1 rad/s pitch rate',...
    'start of flight path','end of flight path','0.1 rad/s yaw rate',...
    'start of flight path','end of flight path'};
controlled_3D = {'0.1 rad/s roll rate','start of flight path',...
    'end of flight path','0.1 rad/s pitch rate','start of flight path',...
    'end of flight path','0.1 rad/s yaw rate','start of flight path',...
    'end of flight path'};
